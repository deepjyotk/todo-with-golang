...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "models.Attachment": {
            ...
            "properties": {
                "attachment_url": {
                    "description": "AttachmentURL is the S3 URL where the attachment is stored.\nrequired: true\nexample: https://s3.amazonaws.com/yourbucket/attachment.jpg",
                    "type": "string"
                },
                "created_at": {
                ...
                "item_id": {
                    "description": "ItemID is the foreign key referencing the parent todo item.\nrequired: true\nexample: 1",
                    "type": "integer"
                },
                "updated_at": {
        ...
        "models.Todo": {
            ...
            "properties": {
                "attachments": {
                    "description": "Attachments holds the related attachments (images/PDFs).",
                    "type": "array",
                    "items": {
                ...
                "user_id": {
                    "description": "UserID is the foreign key referencing the owner user.\nrequired: true\nexample: 42",
                    "type": "integer"
                }
            }
        }
